...
To motivate the basic usage we will assume that the developer is working within the `hellow` R project (i.e., with the working directory at the package root):
